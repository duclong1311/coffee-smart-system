...
const DishGroupList = () => {
  const { isModalOpen, handleAddClick, closeModal, menuList, removeDishGroup } =
  ...
  return (
    <div className="p-1 ">
      ...
      <div className="w-full flex justify-center">
        <div class="md:flex md:items-center mb-2 w-4/5 flex justify-end items-end ">
          <div class="mr-3">
            <input
      ...
      <div className="w-full flex justify-center">
        <div className="w-4/5 flex justify-start items-start mb-2">
          <button
              ...
              <tr className="bg-white" key={item.id}>
                ...
                <td className="border border-gray-400 px-4 py-2 flex justify-center gap-4">
                  ...
                  <div>
                    ...
                    {/* {isModalOpen && <EditDishGroup closeModal={closeModal} />} */}
                  </div>
