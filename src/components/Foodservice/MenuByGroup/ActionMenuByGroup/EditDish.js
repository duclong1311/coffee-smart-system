...
const EditDish = ({ closeModalEditDish, oldDish }) => {
  const { updateDishDetails } = useContext(MyServiceContext);
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-6 rounded-lg shadow-lg w-2/6">
        <h2 className="text-xl font-semibold mb-4">Chỉnh sửa thông tin món </h2>
        <Formik initialValues={oldDish} onSubmit={onSubmitHandler}>
          {({ setFieldValue }) => (
            <Form>
