      ...
      <div className="foodtype-container">
        <div className="left-container">
          <button
            ...
            type="button"
            className="text-white bg-[#6F4F37] hover:bg-[#c48355] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-[#6F4F37] focus:outline-none dark:focus:ring-blue-800"
          >
            Cà phê
          </button>
          <button
            onClick={() => setType("juice")}
            type="button"
            className="text-white bg-[#6F4F37] hover:bg-[#c48355] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-[#6F4F37] focus:outline-none dark:focus:ring-blue-800"
          >
            Nước trái cây
              ...
              currentTableData.map((item, index) => (
                <div className="menu-card" key={`${item}-${index}`}>
                  <div className="food-item max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-5">
                      <h5 className="item-name mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        {item.name}
                      </h5>
                      <p className="item-description mb-3 font-normal text-gray-700 dark:text-gray-400">
                        {item.description}
                      </p>
                      <button
                        onClick={() => handleClickAddToOrder(item)}
                        className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#6F4F37] rounded-lg hover:bg-[#c48355] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-[#6F4F37] dark:focus:ring-blue-800"
                      >
